...
## Документация
Конкретная техническая документация по методам [доступна тут](https://meract.github.io/core/)
...
│   ├───morph-triggers  - Morph триггеры 
│   ├───scripts         - Скрипты фронтенда 
│   ├───models          - Ваши модели
│   ├───routes          - Ваши роуты
...
```
Если хотите дать возможность использовать параметры загрузки в URL добавьте аттрибут `showParams="true"`, тогда параметры загрузки морфа будут отображаться в URL и так же смогут загружаться оттуда.
